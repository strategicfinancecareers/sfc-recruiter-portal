...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 hover:scale-[1.02] active:scale-[0.98]",
  {
    variants: {
      variant: {
        default: "bg-gradient-primary text-primary-foreground hover:shadow-glow hover:brightness-110",
        destructive:
        ...
        "outline-primary": "border border-primary/20 bg-background text-primary hover:bg-primary/10 hover:border-primary/40",
        ghost: "hover:bg-gradient-primary-soft hover:text-foreground",
        link: "text-primary underline-offset-4 hover:underline hover:text-primary-light",
        accent: "bg-gradient-accent text-accent-orange-foreground hover:shadow-glow hover:brightness-110",
      },
      size: {
