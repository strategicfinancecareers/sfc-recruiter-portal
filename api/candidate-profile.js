...
module.exports = async function handler(req, res) {
  try {
    console.log('[candidate-profile] starting', req.method);
    ...
    console.log('[candidate-profile] client created');
    ...
    // ── GET — look up candidate by email ─────────────────────────────────────
    if (req.method === 'GET') {
      ...
      console.log('[candidate-profile] result:', candidate ? 'found' : 'not found', error?.message);
    ...
    console.error('[candidate-profile] CRASH:', err.message, err.stack);
