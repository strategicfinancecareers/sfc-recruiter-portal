              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="space-y-2.5">
                    {revealedProps?.email && (
                      <a href={`mailto:${revealedProps.email}`} className="flex items-center gap-2 text-xs font-medium text-[#005a26] hover:underline min-w-0">
                        <Mail className="w-3.5 h-3.5 shrink-0" />
                        <span className="truncate">{revealedProps.email}</span>
                      </a>
                    )}
                    {revealedProps?.phone && (
