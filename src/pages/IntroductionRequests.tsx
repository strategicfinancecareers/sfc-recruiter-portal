                        ...
                        {request.status === 'approved' && (
                          <div className="rounded-lg border border-emerald-200 bg-emerald-50/60 p-3 space-y-2">
                            ...
                            {request.candidate.email && (
                              <>
                                <a
                                  href={gmailComposeUrl(request.candidate.email, `Introduction via SFC Talent${request.job?.title ? ` - ${request.job.title}` : ''}`)}
                                  target="_blank"
                                  rel="noopener noreferrer"
                                  onClick={(e) => e.stopPropagation()}
                                  className="w-full inline-flex items-center justify-center gap-1.5 bg-[#008037] hover:bg-[#006a2d] text-white rounded-lg px-3 py-2 text-xs font-semibold transition-colors"
                                >
                                ...
                                <p className="flex items-center gap-1.5 text-sm text-emerald-800 min-w-0">
                                  <Mail className="h-3.5 w-3.5 shrink-0" />
                                  <span className="truncate select-all">{request.candidate.email}</span>
                                </p>
                              </>
                            )}
